      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-32">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <a href="/#services" className="text-lg font-semibold text-gray-300 hover:text-blue-400 transition-colors">Services</a>
            <a href="/#booking" className="text-lg font-semibold text-gray-300 hover:text-blue-400 transition-colors">Buchung</a>
            ...
            {showRatings && (
              <a href="#ratings" className="text-lg font-semibold text-gray-300 hover:text-blue-400 transition-colors">Bewertungen</a>
            )}
          </div>
