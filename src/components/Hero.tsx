      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-20">
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 max-w-4xl mx-auto">
            <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg hover:bg-white transition-colors">
            ...
            <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg hover:bg-white transition-colors">
              ...
              <p className="text-gray-600">Sicherer Parkplatz nur 10min vom Flughafen entfernt</p>
            </div>
